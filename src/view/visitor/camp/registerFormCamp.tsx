...
export const RegisterFormCamp = () => {
  return (
    <BottomModal>
      <View>
        <Text style={[sl.textDark, sl.display3, sl.fwBolder]}>Header</Text>
      </View>
      <Text
        style={[
          sl.textSuccess,
        ...
        In React Native, you typically use flex for layout, and it doesn't
        directly support units like
      </Text>
      <View style={[sl.row, sl.colSm12, sl.border, sl.mAuto]}>
        <View
          ...
          <Text style={[sl.display2, sl.textDark, sl.fwBolder]}>12 frw</Text>
        </View>
        <View style={[sl.colSm6]}>
          <View style={[sl.card, sl.colSm12, sl.m0, sl.rounded0, sl.border1]}>
          ...
          <View style={[sl.card, sl.colSm12, sl.m0, sl.rounded0, sl.border1]}>
            ...
            <Text style={[sl.display1, sl.textDark, sl.fwBolder]}>102</Text>
          </View>
        </View>
      </View>
